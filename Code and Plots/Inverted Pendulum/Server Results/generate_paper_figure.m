...
function formatAxesAndLabels(ax)
    ...
    xlabel(ax, 'Angular Velocity ($\omega$)', 'Interpreter', 'latex', 'FontSize', 30);
    ylabel(ax, 'Angle ($\theta$)', 'Interpreter', 'latex', 'FontSize', 30);
    ...
    new_left = 0.15;  % Move it slightly right (5% from left edge of figure)
