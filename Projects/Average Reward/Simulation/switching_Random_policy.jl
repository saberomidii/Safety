...
o_p = CSV.read("/Users/saber/Desktop/Safety/Projects/Average Reward/P_LP/results_primal/2.0/optimal_policy.csv",DataFrame, header=false)

v_f = CSV.read("/Users/saber/Desktop/Safety/Projects/Average Reward/P_LP/results_primal/2.0/G.csv",DataFrame, header=false)
...
scatter!(plot1, [p[1]], [v[1]], color=:green, marker=:circle, markersize=6, label="Initial State")
...
writedlm("position_filter.csv",p)
writedlm("velocity_filter.csv",v)
