...
contourf(x1_grid, x2_grid, g_mask, [0, 0], 'FaceColor', [1 0 0], 'EdgeColor', 'k');
contourf(x1_grid, x2_grid, g_mask, [0.9999, 0.9999], 'FaceColor', 'g', 'EdgeColor', 'k');
...
contourf(x1_grid, x2_grid, G, [1, 1], 'FaceColor', '#009900', 'EdgeColor', 'k');
