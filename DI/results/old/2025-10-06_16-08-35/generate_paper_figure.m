function generate_paper_figure()
    ...
    contour(ax, x_coords, v_coords, Z_lambda0_1, [0.12, 0.0], 'LineWidth', 2, 'Color', [0.4660 0.6740 0.1880], 'LineStyle', ':', 'DisplayName', 'MDR ($Z(x)=0, \lambda=0.1$)');
    contour(ax, x_coords, v_coords, Z_lambda0_2, [0.12, 0.0], 'LineWidth', 2, 'Color', [0.4940 0.1840 0.5560], 'LineStyle', '-.', 'DisplayName', 'MDR ($Z(x)=0, \lambda=0.2$)');
